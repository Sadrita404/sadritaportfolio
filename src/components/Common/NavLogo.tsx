...
export default function NavLogo() {
    ...
    return (
        ...
        <Link href={"/contact"} data-gsap="contact-nav" style={{viewTransitionName: "navContact"}} className="opacity-0 pointer-events-none fixed top-[30px] lg:top-[40px] right-[10px] sm:right-[20px] lg:right-[50px] inline-block px-6 py-2 hover:px-4 transition-[padding] duration-150 text-white group z-[90]">
